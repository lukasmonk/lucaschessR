...
class WManualSave(LCDialog.LCDialog):
    def __init__(self, procesador):
        ...
        self.cb_engine = Controles.CB(self, liMotores, self.configuration.tutor.key).capture_changes(self.reset_motor)
    ...
    def inicializa(self):
        ...
        if dic_vars:
            ...
            self.cb_engine.ponValor(dic_vars.get("ENGINE", self.configuration.tutor_inicial))
